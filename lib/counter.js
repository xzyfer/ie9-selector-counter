...
/**
 * Empty the string literals. Do lazy match. Avoids removing
 * everything after '//' in a string literal.
 */
function emptyStringLiterals(str) {
    str = str || "";
    str = str.replace(/\"[^\n\r]*?\"/g, "''");
    str = str.replace(/'[^\n\r]*?'/g, "''");
    return str;
...
var exports = {
    count: function (file) {
        ...
        input = removeComments(emptyStringLiterals(input))
